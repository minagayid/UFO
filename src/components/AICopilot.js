...
export default function AICopilot({ growthRate, expenseReduction, volatility, revenueKPI, expenseKPI, profitKPI, runwayKPI, juneForecast, low80, high80, }) {
...
How can I help you analyze your operations today? Feel free to ask about runway sustainability, profit maximization, or select one of the quick audits below!`,
    ...
    const generateSimulationResponse = (promptType, userText) => {
...
Perform deep, highly professional, bayesian-informed financial reasoning, and provide structural, actionable insights. Use markdown tables, bold key metrics, and keep suggestions actionable and premium. Be concise but extremely thorough in reasoning. Explain calculations when appropriate.`;
    ...
    return (_jsxs(_Fragment, { children: [_jsxs("button", { onClick: () => setIsOpen(true), className: cn("fixed bottom-6 right-6 p-4 rounded-full shadow-2xl text-white flex items-center justify-center gap-2 group transition-all duration-300 transform hover:scale-105 z-40", isOpen ? "scale-0 opacity-0" : "scale-100 opacity-100", "bg-gradient-to-tr from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500", "after:absolute after:inset-0 after:rounded-full after:bg-blue-400 after:animate-ping after:opacity-10 after:-z-10"), children: [_jsxs("div", { className: "relative", children: [_jsx(Bot, { className: "w-6 h-6 animate-pulse" }), _jsxs("span", { className: "absolute -top-1 -right-1 flex h-2 w-2", children: [_jsx("span", { className: "animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75" }), _jsx("span", { className: "relative inline-flex rounded-full h-2 w-2 bg-emerald-500" })] })] }), _jsx("span", { className: "max-w-0 overflow-hidden group-hover:max-w-xs transition-all duration-500 ease-in-out font-semibold text-sm whitespace-nowrap", children: "AI Copilot" })] }), _jsxs("div", { className: cn("fixed bottom-6 right-6 w-full max-w-md h-[580px] rounded-2xl shadow-2xl flex flex-col overflow-hidden border border-white/20 bg-gray-900/95 backdrop-blur-xl transition-all duration-500 ease-in-out z-50 transform origin-bottom-right", isOpen ? "scale-100 translate-y-0 opacity-100" : "scale-75 translate-y-12 opacity-0 pointer-events-none"), children: [_jsxs("div", { className: "p-4 border-b border-white/10 bg-gradient-to-r from-blue-900/40 via-indigo-900/40 to-purple-900/40 flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx("div", { className: "p-2 bg-blue-500/20 rounded-lg border border-blue-500/30 text-blue-400", children: _jsx(Sparkles, { className: "w-5 h-5 text-blue-400 animate-spin-slow" }) }), _jsxs("div", { children: [_jsxs("div", { className: "flex items-center gap-1.5", children: [_jsx("h3", { className: "font-bold text-white text-sm", children: "UFO-AI Analyst" }), _jsx("span", { className: cn("text-[10px] px-1.5 py-0.5 rounded font-semibold", isSaved ? "bg-emerald-500/10 text-emerald-400 border border-emerald-500/20" : "bg-blue-500/10 text-blue-400 border border-blue-500/20"), children: isSaved ? 'Live LLM' : 'Simulation' })] }), _jsx("p", { className: "text-xs text-gray-400", children: "Financial Strategic Reasoning Agent" })] })] }), _jsxs("div", { className: "flex items-center gap-1.5", children: [_jsx("button", { onClick: () => setShowConfig(!showConfig), className: cn("p-2 rounded-lg transition-colors border", showConfig
                                            ? "bg-white/10 border-white/20 text-white"
                                            : "hover:bg-white/5 border-transparent text-gray-400 hover:text-white"), title: "Configure Gemini API Key", children: _jsx(Key, { className: "w-4 h-4" }) }), _jsx("button", { onClick: () => setIsOpen(false), className: "p-2 text-gray-400 hover:text-white hover:bg-white/5 rounded-lg transition-colors", children: _jsx(X, { className: "w-4 h-4" }) })] })] }), showConfig && (_jsxs("div", { className: "p-4 border-b border-white/10 bg-gray-950/80 text-white text-sm animate-fade-in space-y-3", children: [_jsxs("div", { className: "flex items-start gap-2.5", children: [_jsx(Info, { className: "w-4.5 h-4.5 text-blue-400 flex-shrink-0 mt-0.5" }), _jsxs("div", { className: "space-y-1", children: [_jsx("p", { className: "font-semibold text-xs text-gray-200", children: "Connect Free-Tier Gemini API" }), _jsxs("p", { className: "text-xs text-gray-400 leading-relaxed", children: ["Enter your free Gemini API Key to enable raw, live AI intelligence. Get a free API Key in 30 seconds at", ' ', _jsx("a", { href: "https://aistudio.google.com/", target: "_blank", rel: "noreferrer", className: "text-blue-400 underline hover:text-blue-300 font-semibold", children: "Google AI Studio" }), "."] })] })] }), _jsxs("form", { onSubmit: handleSaveKey, className: "flex gap-2", children: [_jsx("input", { type: "password", placeholder: "Paste Gemini API Key here...", value: apiKey, onChange: (e) => setApiKey(e.target.value), className: "flex-1 bg-gray-900 border border-white/10 rounded-lg px-3 py-1.5 text-xs text-white placeholder-gray-500 focus:outline-none focus:border-blue-500" }), _jsx("button", { type: "submit", className: "bg-blue-600 hover:bg-blue-500 text-white text-xs font-semibold px-3 py-1.5 rounded-lg transition-colors flex items-center gap-1", children: "Save" }), isSaved && (_jsx("button", { type: "button", onClick: handleClearKey, className: "bg-red-950/50 border border-red-500/20 text-red-400 hover:bg-red-950/80 text-xs px-2.5 py-1.5 rounded-lg transition-colors", children: "Clear" }))] })] })), _jsxs("div", { className: "flex-1 overflow-y-auto p-4 space-y-4 scrollbar-thin scrollbar-thumb-white/10", children: [messages.map((msg) => (_jsxs("div", { className: cn("flex flex-col max-w-[85%] rounded-xl p-3 text-sm leading-relaxed", msg.role === 'user'
                                    ? "bg-blue-600 text-white ml-auto rounded-tr-none"
                                    : "bg-white/5 border border-white/10 text-gray-200 mr-auto rounded-tl-none"), children: [msg.role !== 'user' && msg.thinkingSteps && msg.thinkingSteps.length > 0 && (_jsxs("details", { className: "mb-2 border-b border-white/10 pb-1.5 text-xs group", children: [_jsxs("summary", { className: "cursor-pointer text-blue-400 font-semibold flex items-center gap-1 select-none hover:text-blue-300", children: [_jsx(Terminal, { className: "w-3.5 h-3.5" }), _jsx("span", { children: "View AI Reasoning Chain" })] }), _jsx("div", { className: "mt-2 space-y-1.5 font-mono text-gray-400 bg-black/40 p-2 rounded border border-white/5 text-[10px]", children: msg.thinkingSteps.map((step, idx) => (_jsxs("div", { className: "flex items-center gap-1.5", children: [_jsx(Check, { className: "w-3 h-3 text-emerald-500 flex-shrink-0" }), _jsx("span", { children: step })] }, idx))) })] })), _jsx("div", { className: "whitespace-pre-wrap font-sans prose prose-invert prose-sm max-w-none text-xs leading-5", children: msg.content }), _jsx("span", { className: "text-[9px] text-gray-500 mt-1 self-end font-mono", children: new Date(msg.timestamp).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }) })] }, msg.id))), isThinking && (_jsxs("div", { className: "flex flex-col max-w-[85%] bg-white/5 border border-white/10 rounded-xl rounded-tl-none p-3 text-gray-200 mr-auto space-y-3", children: [_jsxs("div", { className: "flex items-center gap-2 text-xs text-blue-400 font-semibold animate-pulse", children: [_jsx(Sparkles, { className: "w-3.5 h-3.5 animate-spin" }), _jsx("span", { children: "AI Reasoner Thinking..." })] }), thinkingSteps.length > 0 && (_jsx("div", { className: "space-y-1 font-mono text-gray-400 bg-black/40 p-2 rounded border border-white/5 text-[10px] animate-fade-in", children: thinkingSteps.map((step, idx) => (_jsxs("div", { className: cn("flex items-center gap-1.5 transition-opacity duration-300", idx === activeStepIndex ? "opacity-100 text-blue-300" : "opacity-60"), children: [idx === activeStepIndex ? (_jsxs("span", { className: "w-3 h-3 flex items-center justify-center", children: [_jsx("span", { className: "animate-ping absolute inline-flex h-1.5 w-1.5 rounded-full bg-blue-400 opacity-75" }), _jsx("span", { className: "relative inline-flex rounded-full h-1 w-1 bg-blue-500" })] })) : (_jsx(Check, { className: "w-3 h-3 text-emerald-500 flex-shrink-0" })), _jsx("span", { children: step })] }, idx))) }))] })), _jsx("div", { ref: messagesEndRef })] }), _jsxs("div", { className: "px-4 py-2 bg-gray-950/40 border-t border-white/5 flex gap-2 overflow-x-auto whitespace-nowrap scrollbar-none scroll-smooth", children: [_jsx("button", { onClick: () => handleSendMessage('risk'), disabled: isThinking, className: "px-2.5 py-1 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 text-gray-300 hover:text-white rounded-lg text-xs font-semibold transition-all flex items-center gap-1", children: "\u26A0\uFE0F Risk Assessment" }), _jsx("button", { onClick: () => handleSendMessage('runway'), disabled: isThinking, className: "px-2.5 py-1 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 text-gray-300 hover:text-white rounded-lg text-xs font-semibold transition-all flex items-center gap-1", children: "\uD83D\uDCCA Runway Audit" }), _jsx("button", { onClick: () => handleSendMessage('growth'), disabled: isThinking, className: "px-2.5 py-1 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 text-gray-300 hover:text-white rounded-lg text-xs font-semibold transition-all flex items-center gap-1", children: "\uD83D\uDCA1 Growth Scenario" })] }), _jsxs("div", { className: "p-3 border-t border-white/10 bg-gray-950/90 flex gap-2", children: [_jsx("input", { type: "text", value: inputMessage, onChange: (e) => setInputMessage(e.target.value), onKeyDown: (e) => e.key === 'Enter' && handleSendMessage(), placeholder: isThinking ? "Analyst is modeling..." : "Ask your financial assistant...", disabled: isThinking, className: "flex-1 bg-gray-900 border border-white/10 rounded-xl px-4 py-2.5 text-xs text-white placeholder-gray-500 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 disabled:opacity-50" }), _jsx("button", { onClick: () => handleSendMessage(), disabled: isThinking || !inputMessage.trim(), className: "p-2.5 bg-blue-600 hover:bg-blue-500 disabled:bg-gray-800 text-white rounded-xl transition-all flex items-center justify-center shadow-lg disabled:opacity-50", children: _jsx(Send, { className: "w-4 h-4" }) })] })] })] }));
}
